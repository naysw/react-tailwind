      ...
      <div>
        <div className="relative">
          {InputProps?.startAdornment && (
            <span className="select-none absolute top-1/2 left-3 right-auto transform -translate-y-1/2">
              {InputProps.startAdornment}
            </span>
          )}
          ...
          {InputProps?.endAdornment && (
            <span className="select-none absolute top-1/2 left-auto transform -translate-y-1/2 right-2">
              {InputProps.endAdornment}
            </span>
          )}
        </div>
